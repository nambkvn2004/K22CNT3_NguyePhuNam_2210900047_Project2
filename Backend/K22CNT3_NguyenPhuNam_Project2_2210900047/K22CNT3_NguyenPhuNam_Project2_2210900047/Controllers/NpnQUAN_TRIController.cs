...
{
    public class NpnQUAN_TRIController : Controller
    {
        ...
        // GET: NpnQUAN_TRI/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: NpnQUAN_TRI/Create
